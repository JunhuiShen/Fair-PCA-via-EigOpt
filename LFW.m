function [M, A, B] = LFW()
    ...
    %
    % Output:
    %   M - Combined centered images data 
    %   A - Centered female images 
    %   B - Centered male images 

    % Add path to the images directory
    addpath images

    % Number of images and size of each image (flattened)
    data_size = 13232; % Total number of images
    img_size = 1764; % Size of each image (flattened)
    ...
    M = images_centered; % Combined centered images data
    A = images_female_centered; % Centered female images
    B = images_male_centered; % Centered male images
