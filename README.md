...
If you want to try our algorithm on a new data set, please remember that our algorithm requires that the average value of matrix $A$ and $B$ should be set to $0$, and $M = [A; B]$.
