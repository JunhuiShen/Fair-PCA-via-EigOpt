...
The **c-FPCA** algorithm is introduced in the paper _"[A novel approach for Fair Principal Component Analysis based on eigendecomposition](https://arxiv.org/abs/1811.00103)"_ by Pelegrina and Duarte. The implementation [`c_FPCA.m`](./c_FPCA.m) is adapted from their code for constrained Fair PCA.
